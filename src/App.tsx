  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-md p-4 mx-auto max-w-2xl">
      ...
      <p className="text-gray-700 text-center">Any questions? Drop a message to <a href="https://share.hsforms.com/1CKZ_K7ruS7GuMd6E3-9Mnws1413"><div className="text-blue-700">Starlet</div></a></p>
